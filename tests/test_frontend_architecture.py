...
def test_retrieval_page_surfaces_runtime_ranking_stack() -> None:
    ...
    assert "function rankingBoostSignalsFromHit" in retrieval_evidence_implementation
    ...
    assert "backendExplanation" in retrieval_evidence_implementation
    assert "aspectIds" in retrieval_evidence_implementation
    assert "bucketIds" in retrieval_evidence_implementation
    assert "conceptIds" in retrieval_evidence_implementation
