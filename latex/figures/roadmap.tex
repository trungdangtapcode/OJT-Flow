...
\node[align=left, text width=9.8cm, anchor=west] at (0,-4.45) {\textbf{Final milestone:} governed healthcare AI workflow prototype with deterministic validation, Graph-NER, advanced retrieval, self-supervised embedding evidence, explainable outputs, GitHub Actions + GCP MLOps path, monitoring, audit, and executive demo.};
