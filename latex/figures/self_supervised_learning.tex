...
\node[box, fill=sfred!7, draw=sfred, text width=3.4cm, below=0.75cm of train] (guard) {Guardrail: do not replace deterministic validation or source-grounded evidence};
