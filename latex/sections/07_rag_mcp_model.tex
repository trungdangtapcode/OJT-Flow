...
\begin{itemize}
  ...
  \item Validate every model-suggested transformation with deterministic tools.
\end{itemize}
...
\begin{figure}[H]
  \centering
  \resizebox{\textwidth}{!}{\input{figures/self_supervised_learning}}
...
The foundation model should be treated as the reasoning and communication layer. Its responsibilities are intent interpretation, workflow planning, tool selection, explanation, summarization, and uncertainty communication. Exact parsing, conversion, schema validation, and storage should remain deterministic.
