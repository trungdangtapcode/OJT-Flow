...
Phase 1: Core data workflow & Weeks 2--4 & Build parser, profiler, deterministic conversion, schema validation, MCP-compatible tool contracts, workflow state, and human review triggers. & Stable core MVP with traceable workflow. \\
