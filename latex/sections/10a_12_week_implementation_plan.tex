...
\begin{itemize}
  ...
  \item The technical scope covers deterministic data tools, Graph-NER, advanced retrieval, self-supervised representation learning, explainable foundation AI, OCR, DICOM workflows, medical segmentation, object detection/tracking, GCP-first MLOps, CI/CD, monitoring, and auditability.
...
\midrule
Member Slot 1 & Backend, architecture, deterministic tools, API contracts, workflow state, schema validation, DICOM/OCR metadata contracts, MCP tool layer, human review, and final integration. & Make OJTFlow usable as a reliable workflow platform, not only a model demo. \\
\addlinespace
...
3 & Deterministic conversion and schema validation & Implement JSON/YAML/CSV/FHIR-like conversion, schema validation, and audit metadata. & Conversion test suite and validation report. \\
...
\midrule
MVP gate, Week 4 & End-to-end workflow trace, deterministic validation, human-review trigger, and basic explanation. & Continue to research tracks only after the core workflow is stable. \\
\addlinespace
