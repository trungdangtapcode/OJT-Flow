...
\addlinespace
Neuro-symbolic layer & Deterministic validators, JSON Schema, FHIR profiles, OMOP constraints, rule engines, ontology/vocabulary checks. & Guardrails around all ML/DL/foundation-model outputs. This is required for medical reliability. \\
\bottomrule
\end{longtable}
...
\begin{figure}[H]
  \centering
  \resizebox{\textwidth}{!}{\input{figures/platform_stack}}
...
Validation coverage & 100\% of returned transformed outputs pass deterministic validation. & Any output bypasses validation. \\
