...
\addlinespace
\risk{Cost and latency} & Agentic workflows can create too many model or retrieval calls. & Cap model calls, cache schema profiles, use rule-based tools, and provide simple direct endpoints. \\
\bottomrule
\end{longtable}
