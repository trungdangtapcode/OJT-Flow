...
| Retrieval packages expose actionable expected-standard and query-aspect coverage diagnostics | `tests/test_retrieval.py::test_retrieval_coverage_reports_missing_expected_standard`, `tests/test_retrieval.py::test_retrieval_coverage_reports_query_aspect_gaps`, `tests/test_retrieval.py::test_static_retrieval_ranks_healthcare_evidence_with_trace`, `docs/retrieval_module_v0.md`, `coverage.standard_system[].suggested_action`, `coverage.standard_system[].suggested_filter`, `coverage.query_aspects[]`, and Retrieval UI coverage rendering in `frontend/src/features/retrieval/retrieval-page.tsx`. |
