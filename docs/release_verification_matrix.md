...
| Retrieval packages expose package-level quality signals | `tests/test_retrieval.py::test_retrieval_quality_signals_flag_missing_standard_coverage`, `tests/test_retrieval.py::test_retrieval_quality_summary_uses_data_driven_policy`, `tests/test_frontend_architecture.py::test_retrieval_page_surfaces_runtime_ranking_stack`, `docs/retrieval_module_v0.md`, `knowledge/retrieval/quality_gate_policy.json`, `quality_signals[]`, `quality_summary`, `handoff_context.quality_policy`, `handoff_context.quality_summary`, and Retrieval UI quality checklist plus readiness-score rendering in `frontend/src/features/retrieval/retrieval-page.tsx`. |
