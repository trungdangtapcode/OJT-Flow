...
| Retrieval query analysis exposes deterministic medical search syntax hints | `tests/test_retrieval.py::test_query_analysis_builds_medical_search_hints`, `tests/test_retrieval.py::test_static_retrieval_ranks_pubmed_mesh_search_evidence`, `docs/retrieval_module_v0.md`, and Retrieval UI search hint rendering in `frontend/src/features/retrieval/retrieval-page.tsx`. |
