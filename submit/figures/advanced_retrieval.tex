...
\node[stage, fill=sfblue!8, draw=sfblue] (query) at (0,0) {User task +\\data/doc/image profile};
...
\node[stage, fill=sforange!10, draw=sforange] (pack) at (15.45,0) {Evidence package\\sources + scores\\boxes / masks};
...
\node[note] at (8.70,-3.95) {Trusted retrieval stores with metadata, schema versions,\\source chunk IDs, OCR boxes, and visual evidence};
