...
export function evaluationReportFromJudgmentSummary(
  ...
  return {
    ...
    server_metrics: {
      ...
      source_policy_blocked_count: evaluation.source_policy_blocked_count,
    },
    local_metrics: {
      ...
      unsafe_count: metrics.unsafeCount,
      stale_count: metrics.staleCount,
      source_policy_blocked_count: metrics.sourcePolicyBlockedCount,
